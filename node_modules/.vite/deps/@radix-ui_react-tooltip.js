...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React13.useRef(true);
  const isPointerInTransitRef = React13.useRef(false);
  const skipDelayTimerRef = React13.useRef(0);
  React13.useEffect(() => {
  ...
  return (0, import_jsx_runtime8.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React13.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React13.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React13.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React13.useRef(false);
  ...
  const stateAttribute = React13.useMemo(() => {
  ...
  const handleDelayedOpen = React13.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  return (0, import_jsx_runtime8.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime8.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React13.useCallback(() => {
...
var TooltipTrigger = React13.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasPointerMoveOpenedRef = React13.useRef(false);
    const handlePointerUp = React13.useCallback(() => isPointerDownRef.current = false, []);
    React13.useEffect(() => {
...
var TooltipContentHoverable = React13.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React13.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React13.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React13.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React13.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React13.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime8.jsxs)(
          Content,
          {
            ...
            children: [
              (0, import_jsx_runtime8.jsx)(Slottable2, { children }),
...
var TooltipArrow = React13.forwardRef(
  (props, forwardedRef) => {
