      ...
      <div className="container mx-auto max-w-6xl animate-fade-in">
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center">
          <div>
            ...
            <p className="text-base md:text-lg text-foreground/95 max-w-xl mb-6 drop-shadow-[0_2px_8px_rgba(0,0,0,0.45)]">
              “Shimon Shnaider — unbelievable IT guy, folks. The best. Maybe the greatest ever. Nobody fixes computers faster.
              I say, ‘Shimon, you’re a genius!’ He says, ‘Done.’ Boom. Servers back online, everything perfect. Tremendous.
              Total winner. Nobody does it better. Shimon — remember the name. Legend.”
            </p>
            <div className="flex flex-wrap gap-4 mb-6">
              <a
                href="#contact"
                className="bg-accent text-primary-foreground font-semibold px-8 py-4 rounded-full hover:bg-accent/90 transition-all shadow-[0_20px_40px_-30px_rgba(246,198,85,0.9)] hover:scale-105"
              >
                Talk?
              </a>
              <a
                href="#experience"
                className="bg-white/5 border border-white/10 px-8 py-4 rounded-full hover:bg-white/10 transition-all hover:scale-105"
              >
                View experience
              </a>
            </div>
            <div className="rounded-2xl border border-accent/30 bg-accent/10 px-4 py-3 text-xs text-muted-foreground mb-8">
              <span className="text-foreground font-semibold">Disclosure:</span> This page and its content
              were generated by an LLM and do not represent the real Shimon.
            </div>
          </div>
